...
<body>
	...
	<div class="content-our" id="our" style="background-color: white;">
		<h3 style="color: #1c2a48;font-size: 40px;font-family: bold" class=" wow fadeInUp animated">International Tours</h3>
		<div class="row">
		<div class="container">
			<?php

 			 $q=$m->runquery("select * from tblpaackage where  ptid=2");
				...
				<div class="col-md-4   wow fadeInRight animated" data-wow-delay=".8s">
						<div class="grid-effect" >
							<figure class="effect-ruby" style="border-radius: 50%;height: 290px;width: 280px">
								<img src="Admin/Package/<?php echo $b['packimage'];?>" class="responsive" height="200px" width="300px"  >
								<figcaption>
									<br><br>
